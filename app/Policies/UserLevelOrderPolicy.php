...
class UserLevelOrderPolicy
{
    ...
    {
        return $adminUser->can('view_any_user::level::order');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, UserLevelOrder $userLevelOrder): bool
    {
        return $adminUser->can('view_user::level::order');
    }
    ...
    {
        return $adminUser->can('create_user::level::order');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, UserLevelOrder $userLevelOrder): bool
    {
        return $adminUser->can('update_user::level::order');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, UserLevelOrder $userLevelOrder): bool
    {
        return $adminUser->can('delete_user::level::order');
    }
    ...
    {
        return $adminUser->can('delete_any_user::level::order');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, UserLevelOrder $userLevelOrder): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, UserLevelOrder $userLevelOrder): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, UserLevelOrder $userLevelOrder): bool
    {
