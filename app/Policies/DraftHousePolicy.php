...
class DraftHousePolicy
{
    ...
    {
        return $adminUser->can('view_any_draft::house');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, DraftHouse $draftHouse): bool
    {
        return $adminUser->can('view_draft::house');
    }
    ...
    {
        return $adminUser->can('create_draft::house');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, DraftHouse $draftHouse): bool
    {
        return $adminUser->can('update_draft::house');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, DraftHouse $draftHouse): bool
    {
        return $adminUser->can('delete_draft::house');
    }
    ...
    {
        return $adminUser->can('delete_any_draft::house');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, DraftHouse $draftHouse): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, DraftHouse $draftHouse): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, DraftHouse $draftHouse): bool
    {
