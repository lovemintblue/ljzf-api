...
class NoticePolicy
{
    ...
    {
        return $adminUser->can('view_any_notice');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Notice $notice): bool
    {
        return $adminUser->can('view_notice');
    }
    ...
    {
        return $adminUser->can('create_notice');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Notice $notice): bool
    {
        return $adminUser->can('update_notice');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Notice $notice): bool
    {
        return $adminUser->can('delete_notice');
    }
    ...
    {
        return $adminUser->can('delete_any_notice');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, Notice $notice): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Notice $notice): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Notice $notice): bool
    {
