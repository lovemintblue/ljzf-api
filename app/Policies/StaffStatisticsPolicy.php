...
class StaffStatisticsPolicy
{
    ...
    {
        return $adminUser->can('view_any_staff::statistics');
    }
    ...
    {
        return $adminUser->can('view_staff::statistics');
    }
    ...
    {
        return $adminUser->can('create_staff::statistics');
    }
    ...
    {
        return $adminUser->can('update_staff::statistics');
    }
    ...
    {
        return $adminUser->can('delete_staff::statistics');
    }
    ...
    {
        return $adminUser->can('delete_any_staff::statistics');
    }
