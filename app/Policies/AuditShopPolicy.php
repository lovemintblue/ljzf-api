...
class AuditShopPolicy
{
    ...
    {
        return $adminUser->can('view_any_audit::shop');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, AuditShop $auditShop): bool
    {
        return $adminUser->can('view_audit::shop');
    }
    ...
    {
        return $adminUser->can('create_audit::shop');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, AuditShop $auditShop): bool
    {
        return $adminUser->can('update_audit::shop');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, AuditShop $auditShop): bool
    {
        return $adminUser->can('delete_audit::shop');
    }
    ...
    {
        return $adminUser->can('delete_any_audit::shop');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, AuditShop $auditShop): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, AuditShop $auditShop): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, AuditShop $auditShop): bool
    {
