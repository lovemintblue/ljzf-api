...
class CarouselPolicy
{
    ...
    {
        return $adminUser->can('view_any_carousel');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Carousel $carousel): bool
    {
        return $adminUser->can('view_carousel');
    }
    ...
    {
        return $adminUser->can('create_carousel');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Carousel $carousel): bool
    {
        return $adminUser->can('update_carousel');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Carousel $carousel): bool
    {
        return $adminUser->can('delete_carousel');
    }
    ...
    {
        return $adminUser->can('delete_any_carousel');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, Carousel $carousel): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Carousel $carousel): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Carousel $carousel): bool
    {
