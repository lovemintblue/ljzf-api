...
class VipUserPolicy
{
    ...
    {
        return $adminUser->can('view_any_vip::user');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, VipUser $vipUser): bool
    {
        return $adminUser->can('view_vip::user');
    }
    ...
    {
        return $adminUser->can('create_vip::user');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, VipUser $vipUser): bool
    {
        return $adminUser->can('update_vip::user');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, VipUser $vipUser): bool
    {
        return $adminUser->can('delete_vip::user');
    }
    ...
    {
        return $adminUser->can('delete_any_vip::user');
    }

    /**
     * Determine whether the adminUser can permanently delete.
     */
    public function forceDelete(AdminUser $adminUser, VipUser $vipUser): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, VipUser $vipUser): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, VipUser $vipUser): bool
    {
